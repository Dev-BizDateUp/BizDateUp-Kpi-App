...
const BadgesApprovalDashboard = () => {
  const location = useLocation();

  const navItems = [
    // { name: "Home", path: "/shine-badges/home" },
    { name: "Approve Badge", path: "/approved-shine-badges/approve-badges" },
    { name: "Approved Badge", path: "/approved-shine-badges/approved-badges" },
  ];
...
export default BadgesApprovalDashboard;
